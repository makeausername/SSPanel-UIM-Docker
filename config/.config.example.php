...
$_ENV['rate_limit_login_ip'] = 10;      // 每分钟每个IP的登录请求限制
$_ENV['rate_limit_login_account'] = 5; // 每分钟每个账户的登录请求限制
$_ENV['rate_limit_register_ip'] = 10;    // 每小时每个IP的注册请求限制
$_ENV['rate_limit_register_account'] = 3; // 每小时每个邮箱的注册请求限制
...
$_ENV['sub_token_len'] = 32;        // 订阅token长度（安全下限为32）
